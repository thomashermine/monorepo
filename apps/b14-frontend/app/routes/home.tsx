...
export default function Home() {
    return (
        <main>
            ...
            <TextSection
                ...
                body={
                    <>
                        ...
                        <em className="text-corten not-italic font-bold">less but better</em>.
                    </>
                }
            />
            ...
            <TextSection
                dark
                title="Deux options. Un même esprit."
                body="Chêne brut ou acier brossé en façade — les deux versions préservent les lignes du loft."
            />
            ...
            <ImageSection
                ...
                caption="Salle de bain — Tons naturels"
            />
