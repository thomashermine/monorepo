    ...
    const vouchers = [
        {
            ...
            url: 'https://craftedsignals-saas.odoo.com/shop/gift-card-49eur-108',
        },
        {
            amount: '99€',
            description: t('vouchers.selection.amounts.99.description'),
            details: t('vouchers.selection.amounts.99.details'),
            url: 'https://craftedsignals-saas.odoo.com/shop/gift-card-99eur-111',
        },
        {
            amount: '199€',
            ...
            featured: false,
            url: 'https://craftedsignals-saas.odoo.com/shop/gift-card-199eur-112',
        },
        {
            amount: '299€',
            ...
            featured: true,
            url: 'https://craftedsignals-saas.odoo.com/shop/gift-card-299eur-113',
        },
        {
            amount: '499€',
            ...
            large: true,
            url: 'https://craftedsignals-saas.odoo.com/shop/gift-card-499eur-114',
        },
    ]
